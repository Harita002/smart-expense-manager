package Har.Expense.Trackers.controller;

import Har.Expense.Trackers.model.Expense;
import Har.Expense.Trackers.model.User;
import Har.Expense.Trackers.repository.UserRepository;
import Har.Expense.Trackers.service.ExpenseService;
...
public class ExpenseController {
    ...
    @GetMapping("/filter")
    public String filterExpenses(@RequestParam Expense.Category category, Model model) {

        List<Expense> filteredExpenses = expenseService.getExpensesByCategory(category);
